      ...
      <div className="container">
        <div className="roww resumo_fn_contact">
          ...
          <div className="resumo_fn_main_title">
            ...
            <h3 className="title2">Entrer en contact</h3>
            <p className="desc">
            Si vous avez des suggestions, un rendez-vous ou même si vous souhaitez dire
« bonjour », veuillez remplir le formulaire ci-dessous et je vous répondrai
sous peu.
            </p>
          </div>
          {/* /Main Title */}
